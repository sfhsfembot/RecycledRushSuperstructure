...
public class OI {
    ...
    public JoystickButton buttonElevenDropRBAtFive;
    public JoystickButton buttonTwelveRBAtSix;
    ...
    public OI() {
        ...
        buttonTwelveRBAtSix = new JoystickButton(operatorStickOne, 12);
        buttonTwelveRBAtSix.whileHeld(new dropTrashCanAtSix());
        buttonElevenDropRBAtFive = new JoystickButton(operatorStickOne, 11);
        buttonElevenDropRBAtFive.whenPressed(new dropTrashCanAtFive());
        buttonTenDropRBAtFourTotes = new JoystickButton(operatorStickOne, 10);
        buttonTenDropRBAtFourTotes.whenPressed(new dropTrashCanAtFour());
        buttonNineDropRBAtThreeTotes = new JoystickButton(operatorStickOne, 9);
        buttonNineDropRBAtThreeTotes.whenPressed(new dropTrashCanAtThree());
        buttonEightDropRBAtTwoTotes = new JoystickButton(operatorStickOne, 8);
        buttonEightDropRBAtTwoTotes.whenPressed(new dropTrashCanAtTwo());
        buttonSevenDropRBatOneTote = new JoystickButton(operatorStickOne, 7);
        buttonSevenDropRBatOneTote.whenPressed(new dropTrashCanAtOne());
        buttonSixDropRBAtZeroTotes = new JoystickButton(operatorStickOne, 6);
        buttonSixDropRBAtZeroTotes.whenPressed(new dropTrashCanAtZero());
        buttonFivePickUpRecycleBin = new JoystickButton(operatorStickOne, 5);
        ...
        buttonOneDispenseAtStep = new JoystickButton(operatorStickOne, 1);
        ...
        buttonThreeManualElevator = new JoystickButton(operatorStickTwo, 3);
        buttonThreeManualElevator.whileHeld(new elevatorUpWithoutLimitSwitch());
        buttonTwoManualElevatorDown = new JoystickButton(operatorStickTwo, 2);
